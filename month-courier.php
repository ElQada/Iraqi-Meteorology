<?php
$Title = "المعدلات اليومية والشهرية للرصد الساعي";
$CurrentFile = "month-courier";
    ...
    foreach ($Stations as $Station)
    {
        ...
        if ($CurrentStation)
        {
            foreach ($SetMonth as $Month)
            {
                ...
                $Records = MySqlX("SELECT `date`,`time`,`H`,`N`,`DD`,`FF`,`SN1`,`TTT`,`SN2`,`TDTDTD`,`P0P0P0P0`,`PPPP`,`A`,`PPP`,`WB`,`RH`,`VP` FROM `courier` WHERE `Station` = ? AND `date` LIKE ?",$Execute,11);
                ...
                $Data = ['Station'=>$CurrentStation['StationName'],'Range'=>$Range,'Count'=>count($Records),'Div'=>$Div,'Records'=>$Records];
...
<form id="month-courier">
    ...
    <div class="ui container center aligned">
        <div class="ui segment">
            ...
            <div class="ui segment">
                <div class="Title"> المعدلات اليومية للرصد الساعي </div>
                <div class="ui Over">
                    <div id="Day-Courier-Wait" class="ui segment" style="display: none; width: 120px; height: 120px;">
                        <div class="ui active inverted dimmer">
                            <div class="ui text loader">Loading</div>
                        </div>
                        <p></p>
                    </div>
                    <div id="Day-Courier" class="Data-Table">
                        <div class="Title" style="width: 100%"> لا تــوجــد بــيــانـــات للــعـــرض </div>
                    </div>
                </div>
            </div>
            <div class="ui segment">
                <div class="Title"> المعدلات الشهرية للرصد الساعي </div>
                <div class="ui Over">
                    <div id="Month-Courier-Wait" class="ui segment" style="display: none; width: 120px; height: 120px;">
                        <div class="ui active inverted dimmer">
                            <div class="ui text loader">Loading</div>
                        </div>
                        <p></p>
                    </div>
                    <div id="Month-Courier" class="Data-Table">
                        <div class="Title" style="width: 100%"> لا تــوجــد بــيــانـــات للــعـــرض </div>
                    </div>
                </div>
            </div>
