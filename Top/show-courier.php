<div class="ui container center aligned" id="Top">
    <div class="ui segment Station_Information">
        ...
        <div class="Information_Item">
            ...
            <div class="ui input">
                <select id="Station" class="Select" name="Station" onchange="{ timech('show-courier'); STtName('show-courier'); }" style="min-width: 220px;">
                    <option disabled> اســم الـمـحـطـة</option>
                    <?php Stations('show-courier'); ?>
                </select>
            </div>
        </div>
        <div class="Information_Item">
            <label for="date"> الـتـاريـخ </label>
            <input type="text" class="_TOP_" placeholder="Date" name="date" id="date" value="<?=_REQUEST_('date',$_SESSION['SelectDate'])?>" style="width: 110px;" onchange="{timech('show-courier'); STtName('show-courier');}" readonly/>
        </div>
        <div class="Information_Item">
